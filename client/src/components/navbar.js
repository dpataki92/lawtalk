    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
            <div className="container-fluid"> <button className="navbar-toggler navbar-toggler-right border-0 p-0" type="button" data-toggle="collapse" data-target="#navbar20">
                    <p className="navbar-brand text-white mb-0"> <i className="fa d-inline fa-lg fa-stop-circle"></i> LAWTALK </p>
                </button>
                <div className="collapse navbar-collapse" id="navbar20">
                    ...
                    <p className="d-none d-md-block lead mb-0 text-white"> <i className="fa d-inline fa-lg fa-stop-circle"></i> <b onClick={handleReload}> LAWTALK</b> </p>
