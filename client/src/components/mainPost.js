            ...
            <h4 style={{marginBottom: "5px"}}>{props.title}</h4>
                <div className="card mb-4">
                    ...
                    <div className="card-footer d-flex flex-wrap justify-content-between align-items-center px-0 pt-0 pb-3">
                        <div class="px-4 pt-3"> <i class="fa fa-reply text-primary"></i>&nbsp; <span class="align-middle text-muted">{props.replies} replies</span> <span class="text-muted d-inline-flex align-items-center align-middle ml-4"> <i class="fa fa-users text-success fsize-3"></i>&nbsp; <span class="align-middle">{props.followers} followers</span> </span> </div>
